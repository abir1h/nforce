      ...
      child: Column(children: [
       SizedBox(height: 24.h,),
        Row(
          ...
          children: [
            Text("Total work order (20)",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 14.sp,fontFamily: "Poppins",color: AppColors.nutralBlack1),),
            Container(
        ...
        ServiceCentreSearchCard(),SizedBox(height: 16.h,),
        ServiceCentreSearchCard(),SizedBox(height: 16.h,),
        ServiceCentreSearchCard(),SizedBox(height: 16.h,),
        ServiceCentreSearchCard(),SizedBox(height: 16.h,),
        ServiceCentreSearchCard(),
      ],),
    );
  }
}

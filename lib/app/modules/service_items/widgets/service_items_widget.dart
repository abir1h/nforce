...
class ServiceItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ServiceItemsController>(
        builder: (controller) {
          return controller.dataLoaded==true?Column(
            children: [
              const SearchWidget(),

              SizedBox(height: 20.sp),
              ItemCountAndSort(items:controller.serviceItems.length.toString() ,),

              Divider(color: AppColors.greyText,thickness: 1,),
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Obx(
                            ...
                            isFavorite: isFavorite.value,data: controller.serviceItems[index],
                            onFavoriteTap: () {

      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ExpandedList(
              header: Text('• ${widget.items[0]}', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14.sp, fontFamily: 'Poppins', color: AppColors.nutralBlack2)),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        '80/1mo',
                        style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, fontFamily: 'Poppins', color: AppColors.nutralBlack1),
                      ),
                      Text(
                        'Save 20/1months',
                        style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400, fontFamily: 'Poppins', color: AppColors.nutralBlack2),
                      ),
                    ],
                  ),
                ),
                const TextCard(buttonText: 'Get Started'),
              ],
            ),
          ],
        ),

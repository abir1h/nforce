...
class BusinessManagerController extends GetxController {
  ...
  final businessManagerCalendarController =
      Get.put(BusinessManagerCalendarController());
  ...
  final contactGroupController =
      Get.put(BusinessManagerContactGroupController());

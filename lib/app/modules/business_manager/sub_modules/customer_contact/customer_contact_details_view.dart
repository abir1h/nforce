...
class CustomerContactDetailsView extends StatefulWidget {
  ...
  const CustomerContactDetailsView({super.key, required this.mainModel});

  @override
  State<CustomerContactDetailsView> createState() =>
      _CustomerContactDetailsViewState();
}

class _CustomerContactDetailsViewState
    extends State<CustomerContactDetailsView> {

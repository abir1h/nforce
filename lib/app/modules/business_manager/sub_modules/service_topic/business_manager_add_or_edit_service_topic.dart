...
class _BusinessManagerAddOrEditCalendarViewState extends State<BusinessManagerAddOrEditServiceTopic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ServiceTopicEditController>(
        builder: (controller) {
                      ...
                      controller.isSaving
                          ...
                          : PrimaryButton(
                              onPressed: () {
                                ...
                                if (controller.formBuilder.textEditingControllers['detailsDescription']?.text.isEmpty == true) {
                                  Fluttertoast.showToast(msg: 'details.description is required');
                                  return;
                                }
                                controller
                                    .addEditDeleteTopic(
                                  ...
                                  action: ActionType.submit,
                                    ...
                                    .then((value) {
                                  if (value == true) {
                                    final data = Get.find<BusinessManagerServiceTopicController>();

...
import 'package:nuforce/app/modules/business_manager/sub_modules/custom_field/agent_view.dart';
        ...
        trailing: [
          Padding(
            ...
            child: GestureDetector(
              onTap: () => Get.toNamed<void>(Routes.SERVICE_ITEMS),
              child: Row(
                children: [
                  Icon(
                    Icons.add,

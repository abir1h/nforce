                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Name for the method, ideally "Check"',
                    ...
                    CustomTextField(label: 'Print on Check', hint: 'Hammer Comms LLC', controller: controller.printCheckController),
                    SizedBox(
                      height: 16.h,
                    ),
                    CustomTextField(label: 'Notes', hint: 'Enter notes', controller: controller.noteController),
                    SizedBox(
                      height: 16.h,
                    ),
                    Text(

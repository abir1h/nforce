...
class _CheckViewState extends State<CheckView> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      body: GetBuilder<CheckController>(builder: (_) {
        return Padding(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  CustomTextField(label: "Print on Check", hint: "Hammer Comms LLC", controller: controller.printCheckController),        SizedBox(height: 16.h,),

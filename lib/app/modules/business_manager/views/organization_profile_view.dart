...
class _OrganizationProfileViewState extends State<OrganizationProfileView> {
  late final OrganizationProfileController ctrl;
  @override
  void initState() {
    super.initState();
    if (OrganizationProfileController().initialized) {
      ctrl = Get.find<OrganizationProfileController>();
    } else {
      ctrl = Get.put(OrganizationProfileController());
      ctrl.getData();
    }
  }

...
import 'package:nuforce/app/modules/business_manager/sub_modules/calender_setting/calendar_settings_view.dart';
...
import 'package:nuforce/app/modules/business_manager/sub_modules/regional_setting/widget/custom_tile.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Settings',
              style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w600, fontSize: 18.sp),
            ),
            SizedBox(
              height: 4.h,
            ),
            ...
            CustomTile(
              onTap: () => Get.to<void>(const RegionalSettingsView()),
            ...
            CustomTile(
              onTap: () => Get.to<void>(const CalenderSettingView()),
            ...
            CustomTile(
              onTap: () => Get.to<void>(const EstimationSettingView()),

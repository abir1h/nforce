...
import 'package:nuforce/app/modules/business_manager/views/business_manager_view.dart';
...
class BusinessManagerSettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        await Get.to<void>(const BusinessManagerView());
      ...
      child: Scaffold(
        ...
        appBar: CustomAppbarMinimal(
          title: 'Settings',
          leadingPressed: () => Get.to<void>(const BusinessManagerView()),
        ),
